# =====================================================================
# ENVIRONMENTS/TESTE/VARIABLES.TF - DEFINIÇÕES GLOBAIS DO AMBIENTE
# =====================================================================
...
variable "vpc_cidr_block" {
  description = "O bloco de IPs para a VPC (Ex: 10.50.0.0/16)."
  type        = string
}
...
variable "tags" {
  description = "Um mapa de tags globais para o ambiente de teste."
  type        = map(string)
  default     = {}
}
