# =====================================================================
#   ENVIRONMENTS/TESTE/MAIN.TF - VERSÃO CORRIGIDA E CONSISTENTE
# =====================================================================
...
module "app_environment" {
  ...
  # Como 'teste' só tem 1 servidor, o 'default = 1' da variável no módulo será usado.
  # Não precisamos passar 'app_server_count' aqui.
  
  # <-- CORREÇÃO: Passando a LISTA completa de sub-redes, como o módulo agora espera.
